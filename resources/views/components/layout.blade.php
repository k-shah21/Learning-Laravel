    ...
    <div class="min-h-full">
                ...
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                <x-nav-link href="/" type="a" :active="request()->is('/')">
                                    Home
                                </x-nav-link>
                    ...
                    <div class="hidden md:block">
                        <div class="ml-4 flex items-center md:ml-6 gap-3">
                            ...
                            <x-nav-link href="/login" type="a" :active="request()->is('login')">
                                Login
                            </x-nav-link>

                            <x-nav-link href="/register" type="a" :active="request()->is('register')">
                                Register
                            </x-nav-link>
                            ...
                            <form method="POST" action="/logout">
                                @csrf
                                <x-nav-link type="button" :active="request()->is('register')">
                                    Logout
                                </x-nav-link>
                            </form>
        ...
        <main>
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                ...
                <!-- This is How we use children Props -->
                <!-- <?php echo $slot ?>  -->


                <!-- This is the shorter way of it -->
                {{ $slot }}
            </div>
        </main>
    </div>
